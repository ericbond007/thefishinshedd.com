...
<<<<<<< HEAD
                    <p className="hours">Early Spring Hours:</p>
                    <p className="hours">Sunday - Thursday: 6AM - 6:00PM</p>
                    <p className="hours">Friday & Saturday: 6AM - 7:30PM</p>
=======
                    <p className="hours">Summer Hours:</p>
                    <p className="hours">Sunday - Thursday: 6AM - 8:00PM</p>
                    <p className="hours">Friday & Saturday: 6AM - 9:30PM</p>
>>>>>>> 2a2c5e0f3358217760574766e03e3fab3145e844
