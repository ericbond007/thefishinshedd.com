    ...
    <Row className="leftjust">
      ...
      <Col sm={8}>
        <Well>
          ...
          <p>
            Come see our recently expanded deli selection! We have grab n' go
            sandwiches for a quick bite, or we can hand make any number of items
            from our menu. Don't be shy, special requests are encouraged! Come
            in on Friday thru Sunday for hot breakfast: Rick's special biscuits
            and sausage gravy, breakfast burritos, and more!
          </p>
          <h2 className="wellHeader">
            <Link to="/fishing">Fresh Live Bait - Year Round!</Link>
          </h2>
          <p>
            The closest bait shop to Lake Monroe and one of the only left in
            Monroe County, The Fishin Shedd is your best bet for the liveliest
            bait fish in town! Always in stock are bass and crappie minnows,
            giant Canadian nightcrawlers and beemoths.
          </p>
        </Well>
      </Col>
    </Row>
